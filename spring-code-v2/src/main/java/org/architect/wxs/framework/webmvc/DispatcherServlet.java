...
import org.architect.wxs.framework.context.ApplicationContext;
...
public class DispatcherServlet extends HttpServlet {
    ...
    private void initHandlerAdapters(ApplicationContext applicationContext) {
        handlerAdapters.add(new HandlerAdapter());
    }
...
//            new GPModelAndView("500");
    ...
    private HandlerAdapter getHandlerAdapter(HandlerMapping handlerMapping) {
        ...
        HandlerAdapter handlerAdapter = handlerAdapters.get(0);
